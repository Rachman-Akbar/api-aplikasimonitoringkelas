...
class AttendanceAndScheduleSeeder extends Seeder
{
    /**
     * Run the database seeds for today's attendance and future schedules.
     */
    public function run(): void
    {
        ...
        // Add 10 Kehadiran Siswa records for today
        $this->addKehadiranSiswa($today);

        // Add 10 Kehadiran Guru records for today
